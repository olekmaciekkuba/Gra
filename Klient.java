...
public class Klient extends JFrame {
    ...
    public Klient () {
            ...
            character1_r      = new Image[4];
            
            character1_r[0]   = new ImageIcon("images/character1/bezruch_r/1.png").getImage();
            character1_r[1]   = new ImageIcon("images/character1/bezruch_r/2.png").getImage();
            character1_r[2]   = new ImageIcon("images/character1/bezruch_r/3.png").getImage();
            character1_r[3]   = new ImageIcon("images/character1/bezruch_r/4.png").getImage();
            
            character1_l      = new Image[4];
            
            character1_l[0]   = new ImageIcon("images/character1/bezruch_l/1.png").getImage();
            character1_l[1]   = new ImageIcon("images/character1/bezruch_l/2.png").getImage();
            character1_l[2]   = new ImageIcon("images/character1/bezruch_l/3.png").getImage();
            character1_l[3]   = new ImageIcon("images/character1/bezruch_l/4.png").getImage();
            
            character1_right_move = new Image[4];
            
            character1_right_move[0]   = new ImageIcon("images/character1/ruch_r/1.png").getImage();
            character1_right_move[1]   = new ImageIcon("images/character1/ruch_r/2.png").getImage();
            character1_right_move[2]   = new ImageIcon("images/character1/ruch_r/3.png").getImage();
            character1_right_move[3]   = new ImageIcon("images/character1/ruch_r/4.png").getImage();
            
            character1_left_move  = new Image[4];
            
            character1_left_move[0]   = new ImageIcon("images/character1/ruch_l/1.png").getImage();
            character1_left_move[1]   = new ImageIcon("images/character1/ruch_l/2.png").getImage();
            character1_left_move[2]   = new ImageIcon("images/character1/ruch_l/3.png").getImage();
            character1_left_move[3]   = new ImageIcon("images/character1/ruch_l/4.png").getImage();
            ...
            this.addKeyListener(new KeyListener(){
                ...
                public void keyPressed(KeyEvent e){
                    ...
                    switch(e.getKeyCode()){
                        ...
                        case KeyEvent.VK_SHIFT:   klawisze[4] = true; break;
                        case KeyEvent.VK_ENTER:   klawisze[5] = true; break;
                        case KeyEvent.VK_ESCAPE:  Chat.hide();napis = ""; openChat = false; break;
                ...
                public void keyReleased(KeyEvent e){
                    switch(e.getKeyCode()){
                        ...
                        case KeyEvent.VK_SHIFT:   klawisze[4] = false; break;
                        case KeyEvent.VK_ENTER:   klawisze[5] = false; break;
                    }
                }
	...
	class UI {
		...
		public String inputHost () {
			...
			if (input == null || input.length() == 0) System.exit(1);
	...
	public static void main (String[] args) {
        ...
        public Image chooseImage(int i,boolean right_move, boolean move, int id){
            Image image;
            
             if(i==1) {
                 if(right_move) {
                     if(!move) {
                         image = character1_r[id];
                     }else{
                         image = character1_right_move[id];
                     }
                 }
                 else {
                     if(!move) {
                         image = character1_l[id];
                     }else{
                         image = character1_left_move[id];
                     }
                 }
            }
                   else if(i == 2) {
        ...
        public void paint(Graphics g)
        {
               ...
               while(it.hasNext())
               {
                   ...
                   postac = chooseImage(character.image,character.right_move,character.move,(character.id+klatka)%4);
               ...
               //Wyswietlanie platform
                ...
                if(czat!=null) {
                    for(int i=0;i<6;i++){
                       if(czat[i]!=null) g2d.drawString(czat[i],10,500+i*15);
                    }
                } 
